...
public class removeDuplicates {
    ...
    */
    public static void main(String[] args) {
        ...
        for (int i = 0; i < useThisArray.length; i++) {
            uniqueSet.add(useThisArray[i]); // uniqueSet'e elemanları ekle
        }

        int nonDuplicateCount = uniqueSet.size(); // uniqueSet'in boyutu, tekrarlamayan eleman sayısını temsil eder
       // System.out.println("nonDuplicateCount : " + nonDuplicateCount);
